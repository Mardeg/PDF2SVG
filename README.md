...
It is **not** intended for standard text-selectable digital layout documents (such as vectorized PDFs containing real type font geometry layers). Also it doesn't currently include detection for non-PNG raster images… contributions welcome!
